...
export const translations = {
  en: {
    ...
    "hero.description": "Choose from 5 AI frameworks, configure 75+ options, and deploy. FastAPI + Next.js with auth, streaming, and infrastructure — ready out of the box.",
    ...
    "template.howitworks.step1.desc": "Choose from 5 AI frameworks, 3 frontends, and 75+ configuration options via the web configurator or CLI.",
    "template.howitworks.step2.title": "Generate & Scaffold",
    "template.howitworks.step2.desc": "One command generates a fully configured project — Docker, CI/CD, auth, database, and your selected AI stack.",
    "template.howitworks.step3.title": "Build Your Agent",
    "template.howitworks.step3.desc": "Focus on your AI logic. The template handles routing, streaming, state management, and deployment boilerplate.",
    "template.howitworks.step4.title": "Ship to Production",
    "template.howitworks.step4.desc": "Deploy with docker compose up. Monitoring, logging, and health checks are pre-configured out of the box.",
    ...
    "oss.manifesto.quote": "After 30+ AI deployments, we kept hitting the same wall: teams spending months building infrastructure instead of solving their actual problem. Every project reinvented auth, streaming, agent orchestration — from scratch. We decided to open-source the patterns that actually survived production, so you can skip the part where everything breaks at 2 AM.",
    "oss.manifesto.author": "Vstorm Team — from the trenches of production AI",
    "oss.manifesto.p1.title": "Modular, Not Monolithic",
    "oss.manifesto.p1.desc": "Pick what you need, leave what you don't. Every package works standalone — no vendor lock-in, no hidden dependencies.",
    "oss.manifesto.p2.title": "Production-Tested First",
    "oss.manifesto.p2.desc": "Nothing ships until it survives real traffic. These aren't weekend prototypes — they're extracted from systems handling real users.",
    "oss.manifesto.p3.title": "Built by Practitioners",
    "oss.manifesto.p3.desc": "We use everything we ship. When something breaks, we feel it first. That's why our tools focus on what actually matters in production.",
    ...
    "deepagents.howitworks.step1.desc": "pip install pydantic-deepagents — one package, zero config, all batteries included.",
    "deepagents.howitworks.step2.title": "Define Your Agent",
    "deepagents.howitworks.step2.desc": "Describe what your agent does with typed tools, system prompts, and optional sub-agents.",
    "deepagents.howitworks.step3.title": "Run",
    "deepagents.howitworks.step3.desc": "Your agent plans, executes, and delegates — streaming results in real time via WebSocket.",
    "deepagents.howitworks.step4.title": "Scale with Sub-Agents",
    "deepagents.howitworks.step4.desc": "Break complex tasks into specialized sub-agents that collaborate autonomously.",
    ...
    "logfire.hero.description": "AI-powered debugging companion for Pydantic Logfire. Ask questions about your traces — get SQL queries, data tables, and charts back instantly.",
    ...
    "footer.restatement.oss.description": "Open-source tools, battle-tested patterns, zero boilerplate. Configure your stack and ship in minutes — not months.",
    "footer.restatement.oss.cta": "Build Your AI App",
    "footer.restatement.template.title": "Ready to ship your AI app?",
    "footer.restatement.template.description": "Pick your frameworks, generate a production-ready project, and deploy. 75+ options, one command, zero config debt.",
    ...
    "footer.restatement.deepagents.description": "Install pydantic-deep, define your agent, and let it plan, code, and delegate — just like Claude Code, but yours.",
    ...
    "footer.restatement.logfire.description": "Install the extension, connect to Logfire, and ask your traces questions in plain English. Free and open-source.",
    ...
    "usecases.index.subtitle": "Real-world use cases with working code examples — research agents, RAG chatbots, SQL agents, and more.",
    ...
    "usecases.cta.description": "Get started with Vstorm's open-source tools — production-tested, fully documented, and free.",
    ...
    "guides.step2.description": "Create the domain-specific tool functions your agent will use to interact with external services.",
    "guides.step3.title": "Create the agent and run",
    "guides.step3.description": "Initialize the {framework} agent with your tools, set the system prompt, and execute a query.",
    ...
    "guides.cta.description": "Generate a production-ready project with {framework} pre-configured — FastAPI + Next.js, auth, streaming, and more.",
    "guides.cta.button": "Get Started",

    // Tools
    "nav.tools": "Free Tools",
    "tools.index.title": "Free AI Agent Tools",
    "tools.index.subtitle": "Interactive tools to help you choose the right AI framework, architecture, and project setup — no signup required.",
    ...
    "tools.configurator.subtitle": "Configure a production-ready FastAPI + Next.js AI agent project with 75+ options. Download as ZIP or CLI — runs locally in under 2 minutes.",
    "tools.configurator.description": "Configure and download a production-ready FastAPI + Next.js AI agent project. Choose from 5 frameworks, 4 databases, and 75+ options — no signup required.",
    ...
    "tools.configurator.step1.desc": "Select AI framework, database, auth, integrations, and infrastructure across 9 configuration steps.",
    "tools.configurator.step2": "Preview your project",
    "tools.configurator.step2.desc": "See a live preview of your project structure, dependencies, and configuration as you build.",
    "tools.configurator.step3": "Download & run",
    "tools.configurator.step3.desc": "Download as ZIP or copy the CLI command. Your project runs locally in under 2 minutes.",
    "tools.configurator.openButton": "Open Configurator",
    "tools.configurator.cta.title": "Ready to build your AI agent project?",
    "tools.configurator.cta.description": "Open the configurator, choose your stack, and download a production-ready project in minutes.",
    "tools.comparison.title": "AI Framework Comparison Calculator",
    "tools.comparison.subtitle": "Answer 6 questions about your project and get a scored recommendation across 5 Python AI agent frameworks.",
    "tools.comparison.description": "Answer 6 quick questions about your project requirements and get a personalized AI framework recommendation with scored results.",
    "tools.comparison.frameworks.title": "Frameworks We Compare",
    "tools.comparison.cta.title": "Want a deeper comparison?",
    "tools.comparison.cta.description": "Check our detailed side-by-side comparisons with feature tables, code examples, and migration guides.",
    "tools.comparison.cta.button": "See Detailed Comparisons",
    "tools.quiz.title": "Agent Architecture Quiz",
    "tools.quiz.subtitle": "Answer 5 quick questions about your project and discover the ideal agent architecture pattern — with a framework recommendation and next steps.",
    "tools.quiz.description": "Take a 5-question quiz to discover the best agent architecture pattern for your use case — from simple ReAct to hierarchical multi-agent systems.",
    ...
    "tools.quiz.cta.description": "Use our framework comparison calculator to find the best framework for your chosen architecture.",
  ...
  pl: {
    ...
    "hero.description": "Wybierz spośród 5 frameworków AI, skonfiguruj 75+ opcji i wdróż. FastAPI + Next.js z autentykacją, streamingiem i infrastrukturą — gotowe od razu.",
    ...
    "template.howitworks.step1.desc": "Wybierz spośród 5 frameworków AI, 3 frontendów i 75+ opcji konfiguracji przez konfigurator webowy lub CLI.",
    "template.howitworks.step2.title": "Wygeneruj i zbuduj",
    "template.howitworks.step2.desc": "Jedna komenda generuje w pełni skonfigurowany projekt — Docker, CI/CD, auth, bazę danych i wybrany stos AI.",
    "template.howitworks.step3.title": "Zbuduj swojego agenta",
    "template.howitworks.step3.desc": "Skup się na logice AI. Szablon obsługuje routing, streaming, zarządzanie stanem i boilerplate wdrożeniowy.",
    "template.howitworks.step4.title": "Wdróż na produkcję",
    "template.howitworks.step4.desc": "Wdróż komendą docker compose up. Monitoring, logowanie i health checki są skonfigurowane od razu.",
    ...
    "oss.hero.description": "Open-source'owe narzędzia Python sprawdzone w 30+ wdrożeniach. Frameworki, szablony i biblioteki — buduj agentów, nie boilerplate.",
    "oss.hero.definition": "Vstorm OSS to zbiór 13 open-sourcex27owych pakietów Python do budowania produkcyjnych agentów AI. Zawiera generator projektów full-stack (FastAPI + Next.js), framework deep agent (planowanie, sandbox, subagenty), pipeline RAG z 4 bazami wektorowymi, middleware z lifecycle hooks, planowanie zadań, kompresję kontekstu i narzędzia bazodanowe. Używany przez 50 000+ deweloperów, 1 730+ gwiazdek na GitHub i 830K+ pobrań z PyPI.",
    "oss.hero.definition": "Vstorm OSS is a collection of 13 open-source Python packages for building production AI agents. It includes a full-stack project generator (FastAPI + Next.js), a deep agent framework (planning, sandboxed execution, subagents), RAG pipeline with 4 vector stores, middleware with lifecycle hooks, task planning, context summarization, and database tooling. Used by 50,000+ developers with 1,730+ GitHub stars and 830K+ PyPI downloads.",
    ...
    "oss.manifesto.quote": "Po ponad 30 wdrożeniach AI ciągle uderzaliśmy w ten sam mur: zespoły spędzały miesiące na budowaniu infrastruktury zamiast rozwiązywać swój właściwy problem. Każdy projekt od nowa wymyślał auth, streaming, orkiestrację agentów — od zera. Postanowiliśmy udostępnić open-source wzorce, które faktycznie przeżyły produkcję, żebyś mógł pominąć etap, w którym wszystko się sypie o 2 w nocy.",
    "oss.manifesto.author": "Zespół Vstorm — z okopów produkcyjnego AI",
    "oss.manifesto.p1.title": "Modularnie, nie monolitycznie",
    "oss.manifesto.p1.desc": "Wybierz co potrzebujesz, zostaw resztę. Każdy pakiet działa samodzielnie — bez vendor lock-in, bez ukrytych zależności.",
    "oss.manifesto.p2.title": "Najpierw przetestowane w produkcji",
    "oss.manifesto.p2.desc": "Nic nie jest publikowane, dopóki nie przetrwa realnego ruchu. To nie weekendowe prototypy — to wzorce wyciągnięte z systemów obsługujących prawdziwych użytkowników.",
    "oss.manifesto.p3.title": "Budowane przez praktyków",
    "oss.manifesto.p3.desc": "Sami używamy wszystkiego co wydajemy. Kiedy coś się psuje, czujemy to pierwsi. Dlatego nasze narzędzia skupiają się na tym, co naprawdę ma znaczenie w produkcji.",
    ...
    "deepagents.howitworks.step1.desc": "pip install pydantic-deepagents — jeden pakiet, zero konfiguracji, wszystko w zestawie.",
    "deepagents.howitworks.step2.title": "Zdefiniuj agenta",
    "deepagents.howitworks.step2.desc": "Opisz co robi Twój agent — typowane narzędzia, system prompts i opcjonalne sub-agenty.",
    "deepagents.howitworks.step3.title": "Uruchom",
    "deepagents.howitworks.step3.desc": "Agent planuje, wykonuje i deleguje — streamując wyniki w czasie rzeczywistym przez WebSocket.",
    "deepagents.howitworks.step4.title": "Skaluj sub-agentami",
    "deepagents.howitworks.step4.desc": "Podziel złożone zadania na wyspecjalizowane sub-agenty współpracujące autonomicznie.",
    ...
    "logfire.hero.description": "Partner do debugowania AI dla Pydantic Logfire. Zadawaj pytania o trace'y — otrzymuj zapytania SQL, tabele danych i wykresy natychmiast.",
    ...
    "footer.restatement.oss.description": "Open-source'owe narzędzia, sprawdzone wzorce, zero boilerplate'u. Skonfiguruj swój stos i wyślij w minuty — nie miesiące.",
    ...
    "footer.restatement.template.description": "Wybierz frameworki, wygeneruj projekt gotowy do produkcji i wdróż. 75+ opcji, jedna komenda, zero długu konfiguracyjnego.",
    ...
    "footer.restatement.deepagents.description": "Zainstaluj pydantic-deep, zdefiniuj swojego agenta i pozwól mu planować, kodować i delegować — jak Claude Code, ale Twój.",
    ...
    "footer.restatement.logfire.description": "Zainstaluj rozszerzenie, połącz z Logfire i zadawaj pytania swoim trace'om po polsku. Za darmo i open-source.",
    ...
    "usecases.index.subtitle": "Praktyczne przypadki użycia z działającymi przykładami kodu — agenci badawczy, chatboty RAG, agenci SQL i więcej.",
    ...
    "usecases.cta.description": "Zacznij z open-source'owymi narzędziami Vstorm — przetestowanymi w produkcji, w pełni udokumentowanymi i darmowymi.",
    ...
    "guides.step2.description": "Stwórz specyficzne dla domeny funkcje narzędzi, których agent będzie używał do interakcji z zewnętrznymi serwisami.",
    "guides.step3.title": "Stwórz agenta i uruchom",
    "guides.step3.description": "Zainicjalizuj agenta {framework} z narzędziami, ustaw prompt systemowy i wykonaj zapytanie.",
    ...
    "guides.cta.description": "Wygeneruj gotowy do produkcji projekt z {framework} — FastAPI + Next.js, autoryzacja, streaming i więcej.",
    "guides.cta.button": "Rozpocznij",

    // Tools
    "nav.tools": "Darmowe narzędzia",
    "tools.index.title": "Darmowe narzędzia AI",
    "tools.index.subtitle": "Interaktywne narzędzia do wyboru odpowiedniego frameworka AI, architektury i konfiguracji projektu — bez rejestracji.",
    ...
    "tools.configurator.subtitle": "Skonfiguruj gotowy do produkcji projekt FastAPI + Next.js z 75+ opcjami. Pobierz jako ZIP lub CLI — uruchom lokalnie w 2 minuty.",
    "tools.configurator.description": "Skonfiguruj i pobierz gotowy do produkcji projekt AI. Wybierz spośród 5 frameworków, 4 baz danych i 75+ opcji — bez rejestracji.",
    ...
    "tools.configurator.step1.desc": "Wybierz framework AI, bazę danych, autoryzację, integracje i infrastrukturę w 9 krokach konfiguracji.",
    "tools.configurator.step2": "Podgląd projektu",
    "tools.configurator.step2.desc": "Zobacz podgląd struktury projektu, zależności i konfiguracji na bieżąco.",
    "tools.configurator.step3": "Pobierz i uruchom",
    "tools.configurator.step3.desc": "Pobierz jako ZIP lub skopiuj komendę CLI. Projekt uruchamia się lokalnie w mniej niż 2 minuty.",
    "tools.configurator.openButton": "Otwórz konfigurator",
    "tools.configurator.cta.title": "Gotowy do budowy projektu AI?",
    "tools.configurator.cta.description": "Otwórz konfigurator, wybierz stos technologiczny i pobierz gotowy projekt w kilka minut.",
    "tools.comparison.title": "Kalkulator porównania frameworków AI",
    "tools.comparison.subtitle": "Odpowiedz na 6 pytań o swoim projekcie i uzyskaj punktowaną rekomendację spośród 5 frameworków AI w Pythonie.",
    "tools.comparison.description": "Odpowiedz na 6 pytań o wymaganiach projektu i uzyskaj spersonalizowaną rekomendację frameworka AI z wynikami.",
    "tools.comparison.frameworks.title": "Porównywane frameworki",
    "tools.comparison.cta.title": "Chcesz dokładniejsze porównanie?",
    "tools.comparison.cta.description": "Sprawdź nasze szczegółowe porównania z tabelami funkcji, przykładami kodu i poradnikami migracji.",
    "tools.comparison.cta.button": "Zobacz szczegółowe porównania",
    "tools.quiz.title": "Quiz architektury agenta",
    "tools.quiz.subtitle": "Odpowiedz na 5 pytań o swoim projekcie i odkryj idealny wzorzec architektury agenta — z rekomendacją frameworka i kolejnymi krokami.",
    "tools.quiz.description": "Rozwiąż quiz z 5 pytań i odkryj najlepszy wzorzec architektury agenta — od prostego ReAct po hierarchiczne systemy wielo-agentowe.",
    ...
    "tools.quiz.cta.description": "Użyj naszego kalkulatora porównania frameworków, aby znaleźć najlepszy framework dla wybranej architektury.",
  ...
  de: {
    ...
    "hero.description": "Wähle aus 5 KI-Frameworks, konfiguriere 75+ Optionen und deploye. FastAPI + Next.js mit Auth, Streaming und Infrastruktur — sofort einsatzbereit.",
    ...
    "template.howitworks.step1.desc": "Wähle aus 5 KI-Frameworks, 3 Frontends und 75+ Konfigurationsoptionen über den Web-Konfigurator oder CLI.",
    "template.howitworks.step2.title": "Generieren & Scaffolden",
    "template.howitworks.step2.desc": "Ein Befehl generiert ein vollständig konfiguriertes Projekt — Docker, CI/CD, Auth, Datenbank und deinen KI-Stack.",
    "template.howitworks.step3.title": "Agent entwickeln",
    "template.howitworks.step3.desc": "Konzentriere dich auf deine KI-Logik. Das Template übernimmt Routing, Streaming, State-Management und Deployment-Boilerplate.",
    "template.howitworks.step4.title": "In Produktion bringen",
    "template.howitworks.step4.desc": "Deploye mit docker compose up. Monitoring, Logging und Health-Checks sind direkt vorkonfiguriert.",
    ...
    "oss.manifesto.p1.desc": "Nimm was du brauchst, lass den Rest. Jedes Paket funktioniert eigenständig — kein Vendor Lock-in, keine versteckten Abhängigkeiten.",
    "oss.manifesto.p2.title": "Zuerst produktionserprobt",
    "oss.manifesto.p2.desc": "Nichts wird veröffentlicht, bis es echten Traffic übersteht. Das sind keine Wochenend-Prototypen — sie stammen aus Systemen mit echten Nutzern.",
    "oss.manifesto.p3.title": "Von Praktikern gebaut",
    "oss.manifesto.p3.desc": "Wir nutzen alles, was wir veröffentlichen, selbst. Wenn etwas kaputt geht, spüren wir es als Erste. Deshalb fokussieren sich unsere Tools auf das, was in der Produktion wirklich zählt.",
    ...
    "deepagents.howitworks.step1.desc": "pip install pydantic-deepagents — ein Paket, null Konfiguration, alles inklusive.",
    "deepagents.howitworks.step2.title": "Agent definieren",
    "deepagents.howitworks.step2.desc": "Beschreibe was dein Agent tut — typisierte Tools, System-Prompts und optionale Sub-Agenten.",
    "deepagents.howitworks.step3.title": "Ausführen",
    "deepagents.howitworks.step3.desc": "Dein Agent plant, führt aus und delegiert — mit Echtzeit-Streaming über WebSocket.",
    "deepagents.howitworks.step4.title": "Mit Sub-Agenten skalieren",
    "deepagents.howitworks.step4.desc": "Teile komplexe Aufgaben in spezialisierte Sub-Agenten auf, die autonom zusammenarbeiten.",
    ...
    "logfire.hero.description": "KI-Debugging-Partner für Pydantic Logfire. Stelle Fragen über deine Traces — erhalte SQL-Abfragen, Datentabellen und Diagramme sofort.",
    ...
    "footer.restatement.oss.description": "Open-Source-Tools, kampferprobte Patterns, null Boilerplate. Konfiguriere deinen Stack und shippe in Minuten — nicht Monaten.",
    "footer.restatement.oss.cta": "Deine KI-App bauen",
    "footer.restatement.template.title": "Bereit, deine KI-App zu shippen?",
    "footer.restatement.template.description": "Wähle deine Frameworks, generiere ein produktionsreifes Projekt und deploye. 75+ Optionen, ein Befehl, null Config-Schulden.",
    ...
    "footer.restatement.deepagents.description": "Installiere pydantic-deep, definiere deinen Agenten und lass ihn planen, coden und delegieren — wie Claude Code, aber deiner.",
    ...
    "footer.restatement.logfire.description": "Installiere die Erweiterung, verbinde mit Logfire und stelle deinen Traces Fragen auf Deutsch. Kostenlos und Open Source.",
    ...
    "usecases.index.subtitle": "Praxisnahe Anwendungsfälle mit funktionierenden Codebeispielen — Research-Agenten, RAG-Chatbots, SQL-Agenten und mehr.",
    ...
    "usecases.cta.description": "Starten Sie mit Vstorms Open-Source-Tools — produktionserprobt, vollständig dokumentiert und kostenlos.",
    ...
    "guides.step2.description": "Erstellen Sie domänenspezifische Tool-Funktionen, die Ihr Agent zur Interaktion mit externen Diensten verwenden wird.",
    "guides.step3.title": "Agent erstellen und ausführen",
    "guides.step3.description": "Initialisieren Sie den {framework}-Agenten mit Ihren Tools, setzen Sie den System-Prompt und führen Sie eine Abfrage aus.",
    ...
    "guides.cta.description": "Generieren Sie ein produktionsbereites Projekt mit vorkonfiguriertem {framework} — FastAPI + Next.js, Auth, Streaming und mehr.",
    "guides.cta.button": "Loslegen",

    // Tools
    "nav.tools": "Kostenlose Tools",
    "tools.index.title": "Kostenlose KI-Agent-Tools",
    "tools.index.subtitle": "Interaktive Tools zur Auswahl des richtigen KI-Frameworks, der Architektur und der Projekteinrichtung — ohne Registrierung.",
    ...
    "tools.configurator.subtitle": "Konfiguriere ein produktionsreifes FastAPI + Next.js KI-Projekt mit 75+ Optionen. Als ZIP herunterladen oder CLI — lokal in 2 Minuten starten.",
    "tools.configurator.description": "Konfiguriere und lade ein produktionsreifes KI-Projekt herunter. Wähle aus 5 Frameworks, 4 Datenbanken und 75+ Optionen — ohne Registrierung.",
    ...
    "tools.configurator.step1.desc": "Wähle KI-Framework, Datenbank, Auth, Integrationen und Infrastruktur in 9 Konfigurationsschritten.",
    "tools.configurator.step2": "Projekt-Vorschau",
    "tools.configurator.step2.desc": "Sieh dir eine Live-Vorschau der Projektstruktur, Abhängigkeiten und Konfiguration an.",
    "tools.configurator.step3": "Herunterladen & starten",
    "tools.configurator.step3.desc": "Als ZIP herunterladen oder CLI-Befehl kopieren. Dein Projekt läuft lokal in unter 2 Minuten.",
    "tools.configurator.openButton": "Konfigurator öffnen",
    "tools.configurator.cta.title": "Bereit, dein KI-Agent-Projekt zu bauen?",
    "tools.configurator.cta.description": "Öffne den Konfigurator, wähle deinen Stack und lade ein produktionsreifes Projekt in Minuten herunter.",
    "tools.comparison.title": "KI-Framework-Vergleichsrechner",
    "tools.comparison.subtitle": "Beantworte 6 Fragen zu deinem Projekt und erhalte eine bewertete Empfehlung aus 5 Python-KI-Frameworks.",
    "tools.comparison.description": "Beantworte 6 Fragen zu deinen Anforderungen und erhalte eine personalisierte KI-Framework-Empfehlung mit Ergebnissen.",
    ...
    "tools.comparison.cta.description": "Sieh dir unsere detaillierten Vergleiche mit Feature-Tabellen, Code-Beispielen und Migrationsanleitungen an.",
    "tools.comparison.cta.button": "Detaillierte Vergleiche ansehen",
    "tools.quiz.title": "Agenten-Architektur-Quiz",
    "tools.quiz.subtitle": "Beantworte 5 Fragen zu deinem Projekt und entdecke das ideale Architekturmuster — mit Framework-Empfehlung und nächsten Schritten.",
    "tools.quiz.description": "Mach ein 5-Fragen-Quiz und finde das beste Agenten-Architekturmuster — von einfachem ReAct bis zu hierarchischen Multi-Agenten-Systemen.",
    "tools.quiz.patterns.title": "Architekturmuster, die wir bewerten",
    "tools.quiz.cta.title": "Architektur klar — jetzt Framework wählen",
    "tools.quiz.cta.description": "Nutze unseren Framework-Vergleichsrechner, um das beste Framework für deine gewählte Architektur zu finden.",
  ...
  es: {
    ...
    "hero.description": "Elige entre 5 frameworks de IA, configura 75+ opciones y despliega. FastAPI + Next.js con auth, streaming e infraestructura — listo para usar.",
    ...
    "template.howitworks.step1.desc": "Elige entre 5 frameworks de IA, 3 frontends y más de 75 opciones de configuración a través del configurador web o CLI.",
    "template.howitworks.step2.title": "Genera y estructura",
    "template.howitworks.step2.desc": "Un comando genera un proyecto completamente configurado — Docker, CI/CD, auth, base de datos y tu stack de IA seleccionado.",
    "template.howitworks.step3.title": "Construye tu agente",
    "template.howitworks.step3.desc": "Concéntrate en tu lógica de IA. La plantilla maneja routing, streaming, gestión de estado y boilerplate de despliegue.",
    "template.howitworks.step4.title": "Despliega a producción",
    "template.howitworks.step4.desc": "Despliega con docker compose up. Monitoreo, logging y health checks están preconfigurados de serie.",
    ...
    "oss.hero.description": "Herramientas Python open source probadas en 30+ despliegues reales. Frameworks, plantillas y bibliotecas — construye agentes, no boilerplate.",
    "oss.hero.definition": "Vstorm OSS is a collection of 13 open-source Python packages for building production AI agents. It includes a full-stack project generator (FastAPI + Next.js), a deep agent framework (planning, sandboxed execution, subagents), RAG pipeline with 4 vector stores, middleware with lifecycle hooks, task planning, context summarization, and database tooling. Used by 50,000+ developers with 1,730+ GitHub stars and 830K+ PyPI downloads.",
    "oss.hero.definition": "Vstorm OSS es una colección de 13 paquetes Python open-source para construir agentes de IA en producción. Incluye un generador de proyectos full-stack (FastAPI + Next.js), un framework de agentes profundos (planificación, sandbox, subagentes), pipeline RAG con 4 bases vectoriales, middleware con lifecycle hooks, planificación de tareas, compresión de contexto y herramientas de base de datos. Usado por más de 50.000 desarrolladores, 1.730+ estrellas en GitHub y 830K+ descargas de PyPI.",
    ...
    "oss.manifesto.quote": "Después de más de 30 despliegues de IA, seguíamos chocando contra el mismo muro: equipos pasando meses construyendo infraestructura en lugar de resolver su problema real. Cada proyecto reinventaba auth, streaming, orquestación de agentes — desde cero. Decidimos hacer open-source los patrones que realmente sobrevivieron producción, para que puedas saltarte la parte donde todo se rompe a las 2 de la madrugada.",
    ...
    "oss.manifesto.p1.desc": "Toma lo que necesitas, deja el resto. Cada paquete funciona de forma independiente — sin vendor lock-in, sin dependencias ocultas.",
    "oss.manifesto.p2.title": "Probado en producción primero",
    "oss.manifesto.p2.desc": "Nada se publica hasta que sobrevive tráfico real. No son prototipos de fin de semana — están extraídos de sistemas que sirven usuarios reales.",
    "oss.manifesto.p3.title": "Construido por practicantes",
    "oss.manifesto.p3.desc": "Usamos todo lo que publicamos. Cuando algo se rompe, lo sentimos primero. Por eso nuestras herramientas se centran en lo que realmente importa en producción.",
    ...
    "deepagents.howitworks.step1.desc": "pip install pydantic-deepagents — un paquete, cero configuración, todo incluido.",
    "deepagents.howitworks.step2.title": "Define tu agente",
    "deepagents.howitworks.step2.desc": "Describe qué hace tu agente — herramientas tipadas, system prompts y sub-agentes opcionales.",
    "deepagents.howitworks.step3.title": "Ejecuta",
    "deepagents.howitworks.step3.desc": "Tu agente planifica, ejecuta y delega — transmitiendo resultados en tiempo real por WebSocket.",
    "deepagents.howitworks.step4.title": "Escala con sub-agentes",
    "deepagents.howitworks.step4.desc": "Divide tareas complejas en sub-agentes especializados que colaboran de forma autónoma.",
    ...
    "logfire.hero.description": "Compañero de depuración con IA para Pydantic Logfire. Haz preguntas sobre tus traces — obtén consultas SQL, tablas y gráficos al instante.",
    ...
    "footer.restatement.oss.description": "Herramientas open-source, patrones probados en batalla, cero boilerplate. Configura tu stack y despliega en minutos — no meses.",
    "footer.restatement.oss.cta": "Crea tu app de IA",
    "footer.restatement.template.title": "¿Listo para desplegar tu app de IA?",
    "footer.restatement.template.description": "Elige tus frameworks, genera un proyecto listo para producción y despliega. 75+ opciones, un comando, cero deuda de configuración.",
    ...
    "footer.restatement.deepagents.description": "Instala pydantic-deep, define tu agente y déjalo planificar, codear y delegar — como Claude Code, pero tuyo.",
    ...
    "footer.restatement.logfire.description": "Instala la extensión, conéctate a Logfire y pregunta a tus trazas en español. Gratis y open-source.",
    ...
    "usecases.index.subtitle": "Casos de uso del mundo real con ejemplos de código funcional — agentes de investigación, chatbots RAG, agentes SQL y más.",
    ...
    "usecases.cta.description": "Comienza con las herramientas open-source de Vstorm — probadas en producción, completamente documentadas y gratuitas.",
    ...
    "guides.step2.description": "Crea las funciones de herramientas específicas del dominio que tu agente usará para interactuar con servicios externos.",
    "guides.step3.title": "Crear el agente y ejecutar",
    "guides.step3.description": "Inicializa el agente de {framework} con tus herramientas, establece el prompt del sistema y ejecuta una consulta.",
    ...
    "guides.cta.description": "Genera un proyecto listo para producción con {framework} preconfigurado — FastAPI + Next.js, auth, streaming y más.",
    "guides.cta.button": "Comenzar",

    // Tools
    "nav.tools": "Herramientas gratis",
    "tools.index.title": "Herramientas de IA gratuitas",
    "tools.index.subtitle": "Herramientas interactivas para elegir el framework de IA, la arquitectura y la configuración del proyecto adecuados — sin registro.",
    ...
    "tools.configurator.subtitle": "Configura un proyecto FastAPI + Next.js listo para producción con 75+ opciones. Descarga como ZIP o CLI — ejecútalo en 2 minutos.",
    "tools.configurator.description": "Configura y descarga un proyecto de IA listo para producción. Elige entre 5 frameworks, 4 bases de datos y 75+ opciones — sin registro.",
    ...
    "tools.configurator.step1.desc": "Selecciona el framework de IA, base de datos, autenticación, integraciones e infraestructura en 9 pasos.",
    "tools.configurator.step2": "Vista previa del proyecto",
    "tools.configurator.step2.desc": "Ve una vista previa en vivo de la estructura, dependencias y configuración del proyecto.",
    "tools.configurator.step3": "Descarga y ejecuta",
    "tools.configurator.step3.desc": "Descarga como ZIP o copia el comando CLI. Tu proyecto se ejecuta localmente en menos de 2 minutos.",
    ...
    "tools.configurator.cta.description": "Abre el configurador, elige tu stack y descarga un proyecto listo para producción en minutos.",
    "tools.comparison.title": "Calculadora de comparación de frameworks IA",
    "tools.comparison.subtitle": "Responde 6 preguntas sobre tu proyecto y obtén una recomendación puntuada de 5 frameworks de IA en Python.",
    "tools.comparison.description": "Responde 6 preguntas sobre los requisitos de tu proyecto y obtén una recomendación personalizada con resultados puntuados.",
    ...
    "tools.comparison.cta.description": "Consulta nuestras comparaciones detalladas con tablas de características, ejemplos de código y guías de migración.",
    "tools.comparison.cta.button": "Ver comparaciones detalladas",
    "tools.quiz.title": "Quiz de arquitectura de agentes",
    "tools.quiz.subtitle": "Responde 5 preguntas sobre tu proyecto y descubre el patrón de arquitectura ideal — con recomendación de framework y próximos pasos.",
    "tools.quiz.description": "Haz un quiz de 5 preguntas y descubre el mejor patrón de arquitectura — desde ReAct simple hasta sistemas jerárquicos multi-agente.",
    ...
    "tools.quiz.cta.description": "Usa nuestra calculadora de comparación de frameworks para encontrar el mejor framework para tu arquitectura.",
