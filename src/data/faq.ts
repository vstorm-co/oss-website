...
export const faqItems: FaqItem[] = [
  ...
  // ── DeepAgents FAQ ─────────────────────────────────────────
  {
    ...
    answer: {
      en: "A Python framework for building autonomous AI agents inspired by Claude Code's architecture. It implements the deep agent pattern — agents that can plan, read/write files, delegate to subagents, and maintain persistent memory across sessions.",
  ...
  },
  {
    ...
    answer: {
      en: "DeepAgents is type-safe by default (Pydantic models, not dicts), modular (compose tools, not chains), and observable (Logfire integration). It focuses on the deep agent pattern — long-running agents that plan and execute autonomously — rather than simple chain-of-thought or multi-agent chat.",
  ...
  },
  {
    ...
    answer: {
      en: "Any provider supported by Pydantic AI — OpenAI, Anthropic, Google Gemini, Groq, Mistral, and any OpenAI-compatible API (like Ollama for local models). Swap providers with one line of configuration.",
  ...
  },
  {
    ...
    answer: {
      en: "Yes. Define tools using the @tool decorator from Pydantic AI. Tools are type-checked, support async execution, and integrate with the permission system. You can also use pre-built toolsets (filesystem, database, console) from companion libraries.",
  ...
  },
  {
    ...
    answer: {
      en: "Yes. DeepAgents powers 30+ production deployments at Vstorm. It includes structured logging via Logfire, error recovery, token usage tracking, and has been battle-tested in real-world AI agent applications.",
  ...
  // ── Logfire FAQ ────────────────────────────────────────────
  {
    ...
    answer: {
      en: "A Chrome extension with a FastAPI backend that adds an AI-powered sidebar to the Pydantic Logfire dashboard. Ask questions about your traces in natural language, get SQL queries generated automatically, and see results as tables or charts — all without leaving your browser.",
  ...
  },
  {
    ...
    answer: {
      en: "Yes. Logfire Assistant queries your Logfire data via the Logfire API. You need a Logfire account with at least one project that has trace data. The assistant uses your Logfire read token to access your data securely.",
  ...
  },
  {
    ...
    answer: {
      en: "OpenAI, Anthropic, Google Gemini, and any OpenAI-compatible API. Configure your preferred provider in the backend settings. The AI generates Logfire-specific SQL queries optimized for the traces schema.",
  ...
  },
  {
    ...
    answer: {
      en: "Yes. Create reusable prompt templates with slash commands like /errors, /costs, or /slow. Templates can include variables and are saved per-project. Share them across your team for consistent debugging workflows.",
  ...
  },
  {
    ...
    answer: {
      en: "Conversations are stored in your own PostgreSQL database that you host. No data is sent to third parties beyond the LLM API calls. The Chrome extension communicates only with your self-hosted FastAPI backend.",
