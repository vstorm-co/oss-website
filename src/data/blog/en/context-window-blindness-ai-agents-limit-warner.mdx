...
*I'm Kacper Włodarczyk, co-founder of [Vstorm](https://vstorm.co) — an Applied Agentic AI Engineering consultancy. We've deployed 30+ production AI agents. [pydantic-deep](https://github.com/vstorm-co/pydantic-deep) is our open-source AI coding agent — the modular agent runtime for Python.*
...
*Vstorm builds production AI agent systems. If your team is deploying agents and running into context management at scale — [vstorm.co](https://vstorm.co).*
