---
title: "Your AI Agent Forgets Everything After 50 Messages. Here's the Fix."
...
So we built [`summarization-pydantic-ai`](https://github.com/vstorm-co/summarization-pydantic-ai) - two processors that manage your agent's conversation history: one that summarizes intelligently using an LLM, and one that simply trims old messages for zero cost.
