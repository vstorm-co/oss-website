...
|                      | [DeepAgents](https://github.com/vstorm-co/pydantic-deepagents) | Yes         |
...
[full-stack-fastapi-nextjs-llm-template](https://github.com/vstorm-co/full-stack-ai-agent-template) -- Production-ready project generator for AI/LLM applications with FastAPI + Next.js + 20+ integrations.
