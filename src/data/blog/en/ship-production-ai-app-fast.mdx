...
[full-stack-fastapi-nextjs-llm-template](https://github.com/vstorm-co/full-stack-fastapi-nextjs-llm-template) -- Production-ready project generator for AI/LLM applications with FastAPI + Next.js + 20+ integrations.
