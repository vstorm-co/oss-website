...
description: "Standard dashboards don't work for LLM traces. We built an AI assistant that lets you ask questions about your agent's behavior in plain English - natural language to SQL queries against Logfire data."
pubDate: 2026-02-19
author: "Vstorm"
lang: en
...
[logfire-assistant](https://github.com/vstorm.co/projects/logfire-assistant) - AI-powered Logfire assistant with natural language to SQL queries, Chrome extension, and multi-span analysis.
