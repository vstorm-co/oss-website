...
[logfire-assistant](https://github.com/vstorm-co/logfire-assistant) - AI-powered Logfire assistant with natural language to SQL queries, Chrome extension, and multi-span analysis.
