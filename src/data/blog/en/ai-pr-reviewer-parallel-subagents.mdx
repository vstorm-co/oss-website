...
Here's the complete implementation using [pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents):
...
If you're using [pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents) as a CLI (like Claude Code), you can register this as a slash command:
...
[pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents) is an open-source implementation of this pattern, built on [Pydantic AI](https://ai.pydantic.dev/). It's the framework we use at [Vstorm](https://vstorm.co) to ship production AI agents — and the PR reviewer is one of the simplest things you can build with it.

## Try It

- **Repository:** [pydantic-deepagents on GitHub](https://github.com/vstorm-co/pydantic-deepagents)
...
*I'm Kacper, AI Engineer at [Vstorm](https://vstorm.co) — an Applied Agentic AI Engineering Consultancy. We build and open-source production AI agent tooling in Python. Star [pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents) on GitHub if you find it useful.*
