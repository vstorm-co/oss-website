...
seoTitle: "Zero to Production AI Agent in 30 Minutes"
...
import FrameworkBadge from "@/components/blog/FrameworkBadge.astro";
import TLDR from "@/components/blog/TLDR.astro";

<MetricsBar
  metrics={[
    { value: "614", label: "GitHub Stars" },
    { value: "5", label: "AI Frameworks" },
    { value: "75+", label: "Config Options" },
    { value: "30 min", label: "Time to Production" },
  ]}
/>
...
<RepoCard
  ...
  description="Open-source full-stack template with 5 AI frameworks, 75+ configuration options, and a web configurator that generates your entire project in minutes."
  stars="614"
  language="Python"
/>

Used by teams at NVIDIA, Pfizer, TikTok, and others. And you can go from zero to a running production AI agent in about 30 minutes.
...
<Callout type="info" title="One directory to focus on">
  After generation, almost all your custom code lives in `backend/app/agents/`. Everything else is
  scaffolding you can ignore until you need to extend it.
</Callout>
