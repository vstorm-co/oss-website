...
We shipped hashline support in [pydantic-ai-backend](https://github.com/vstorm-co/pydantic-ai-backend) v0.1.9, inspired directly by Can Boluk's research. Here's how it works.
