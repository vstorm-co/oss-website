...
_by [Kacper Włodarczyk](https://linkedin.com/in/kacper-wlodarczyk/) — AI Engineering Lead at [Vstorm](https://vstorm.co). We build production AI agent systems and open-source the hard parts. Follow along on [GitHub](https://github.com/vstorm-co/pydantic-deep) or [oss.vstorm.co](https://oss.vstorm.co)._
