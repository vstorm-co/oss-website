...
- **[DeepAgents](https://github.com/vstorm-co/pydantic-deepagents) for modular agent systems.** Claude Code-inspired architecture with standalone packages. Growing fast, best for teams that want fine-grained control.
