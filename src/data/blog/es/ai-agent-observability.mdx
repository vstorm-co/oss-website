...
[logfire-assistant](https://github.com/vstorm-co/logfire-assistant) - asistente Logfire potenciado por IA con consultas en lenguaje natural a SQL, extension de Chrome y analisis multi-span.
