...
Aqui esta la implementacion completa usando [pydantic-deepagents](https://github.com/vstorm.co/projects/pydantic-deepagents):
...
- **`description`** — le dice al agente principal _cuando_ usar este subagente (la logica de enrutamiento)
...
Si estas usando [pydantic-deepagents](https://github.com/vstorm.co/projects/pydantic-deepagents) como CLI (como Claude Code), puedes registrar esto como un slash command:
...
_Soy Kacper, AI Engineer en [Vstorm](https://vstorm.co) — una consultoria de Applied Agentic AI Engineering. Construimos y publicamos como open-source herramientas de agentes AI para produccion en Python. Dale una estrella a [pydantic-deepagents](https://github.com/vstorm.co/projects/pydantic-deepagents) en GitHub si lo encuentras util._
