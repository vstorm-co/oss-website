...
Fundamentalny problem: wiekszość systemow pamieci AI jest zaprojektowana, aby _pamietac wszystko_. Ale najlepsza ludzka pamiec dziala poprzez _zapominanie prawie wszystkiego_ i zachowywanie tylko tego, co wazne.

Po latach pracy z agentami produkcyjnymi w Vstorm, doszlismy do innego podejscia. Zamiast przechowywac kazda wiadomosc w bazie wektorowej, dajemy agentowi ustrukturyzowany system plikow dla trwalej pamieci - i uczymy go decydowac, _co jest warte zapisania_.
