...
- **`description`** — mowi agentowi nadrzednemu _kiedy_ uzywac tego subagenta (logika routingu)
...
_Jestem Kacper, AI Engineer w [Vstorm](https://vstorm.co) — Applied Agentic AI Engineering Consultancy. Budujemy i udostepniamy na open-source produkcyjne narzedzia do agentow AI w Pythonie. Daj gwiazdke [pydantic-deepagents](https://github.com/vstorm.co/projects/pydantic-deepagents) na GitHub, jesli uznasz to za przydatne._
