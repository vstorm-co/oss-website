...
Oto kompletna implementacja uzywajaca [pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents):
...
Jesli uzywasz [pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents) jako CLI (jak Claude Code), mozesz zarejestrowac to jako slash command:
...
[pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents) to open-source implementacja tego wzorca, zbudowana na [Pydantic AI](https://ai.pydantic.dev/). To framework, ktorego uzywamy w [Vstorm](https://vstorm.co) do wysylania produkcyjnych agentow AI — a PR reviewer to jedna z najprostszych rzeczy, ktore mozesz z nim zbudowac.

## Wyprobuj

- **Repozytorium:** [pydantic-deepagents na GitHub](https://github.com/vstorm-co/pydantic-deepagents)
...
*Jestem Kacper, AI Engineer w [Vstorm](https://vstorm.co) — Applied Agentic AI Engineering Consultancy. Budujemy i udostepniamy na open-source produkcyjne narzedzia do agentow AI w Pythonie. Daj gwiazdke [pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents) na GitHub, jesli uznasz to za przydatne.*
