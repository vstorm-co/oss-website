...
Hier ist die komplette Implementierung mit [pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents):
...
Wenn Sie [pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents) als CLI verwenden (wie Claude Code), koennen Sie dies als Slash-Command registrieren:
