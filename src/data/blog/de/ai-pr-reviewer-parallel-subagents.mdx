...
- **`description`** — sagt dem uebergeordneten Agenten, _wann_ dieser Subagent eingesetzt werden soll (die Routing-Logik)
...
_Ich bin Kacper, AI Engineer bei [Vstorm](https://vstorm.co) — einer Applied Agentic AI Engineering Consultancy. Wir bauen und veroeffentlichen produktionsreife AI-Agent-Tools in Python als Open Source. Geben Sie [pydantic-deepagents](https://github.com/vstorm.co/projects/pydantic-deepagents) einen Stern auf GitHub, wenn Sie es nuetzlich finden._
