...
- [pydantic-deepagents](https://github.com/vstorm.co/projects/pydantic-deepagents) — Modulares AI-Agent-Framework (Claude Code Architektur, Open Source)
