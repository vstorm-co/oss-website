...
export function FrontendStep() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-text text-xl font-semibold tracking-tight">Frontend</h2>
        <p className="text-text-tertiary mt-1 text-sm">Choose your frontend framework</p>
      </div>

      <div className="grid gap-5">
        <div>
          <label className="text-text mb-2 block text-sm font-medium">Frontend Framework</label>
          <RadioGroup
